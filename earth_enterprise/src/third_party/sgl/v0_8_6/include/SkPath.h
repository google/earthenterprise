...
public:
    ...
    */
    bool    isEmpty() const;
    /** Returns true if the path specifies a rectangle. If so, and if rect is not null,
    ...
    */
    ...
    /** Calling this will, if the internal cache of the bounds is out of date, update it so that subsequent
        calls to computeBounds will be instanteous. This also means that any copies or simple transformations
        of the path will inherit the cached bounds.
    */
