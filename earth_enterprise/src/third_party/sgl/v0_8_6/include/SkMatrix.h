...
public:
    ...
    */
    ...
    /** Returns true if will map a rectangle to another rectangle. This can be true
        if the matrix is identity, scale-only, or rotates a multiple of 90 degrees.
    */
    ...
    */
    ...
    /** If this matrix can be inverted, return true and if inverse is not null, set inverse
    ...
    */
    ...
    typedef void (SkMatrix::*MapProc)(SkPoint dst[], const SkPoint src[], int count) const;
    static MapProc GetMapProc(TypeMask);
    MapProc getMapProc() const { return SkMatrix::GetMapProc(this->getType()); }
...
private:
    ...
    // variations of mapPoints()
    
    void identity_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    void trans_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    void scale_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    void scaleTrans_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    void rot_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    void rotTrans_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    void persp_MapProc(SkPoint dst[], const SkPoint src[], int count) const;
    
    static const MapProc gMapPocs[];
