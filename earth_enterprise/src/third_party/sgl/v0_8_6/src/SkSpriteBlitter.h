...
public:
    ...
    static SkSpriteBlitter* ChooseD16(const SkBitmap& source, SkXfermode* mode, uint8_t alpha,
                                      void* storage, size_t storageSize);
    static SkSpriteBlitter* ChooseD32(const SkBitmap& source, SkXfermode* mode, uint8_t alpha,
                                      void* storage, size_t storageSize);
