...
class Keyword(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='Keyword'):
        if self.vocabulary is not None and 'vocabulary' not in already_processed:
            ...
            outfile.write(' vocabulary=%s' % (self.gds_format_string(quote_attrib(self.vocabulary), input_name='vocabulary'), ))
...
class OnlineResource(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='OnlineResource'):
        if self.title is not None and 'title' not in already_processed:
            ...
            outfile.write(' title=%s' % (self.gds_format_string(quote_attrib(self.title), input_name='title'), ))
        if self.arcrole is not None and 'arcrole' not in already_processed:
            already_processed.append('arcrole')
            outfile.write(' arcrole=%s' % (self.gds_format_string(quote_attrib(self.arcrole), input_name='arcrole'), ))
        if self.actuate is not None and 'actuate' not in already_processed:
            already_processed.append('actuate')
            outfile.write(' actuate=%s' % (self.gds_format_string(quote_attrib(self.actuate), input_name='actuate'), ))
        if self.href is not None and 'href' not in already_processed:
            already_processed.append('href')
            # jeffdonner added xlink:
            outfile.write(' xlink:href=%s' % (self.gds_format_string(quote_attrib(self.href), input_name='href'), ))
        if self.role is not None and 'role' not in already_processed:
            already_processed.append('role')
            outfile.write(' role=%s' % (self.gds_format_string(quote_attrib(self.role), input_name='role'), ))
        if self.show is not None and 'show' not in already_processed:
            already_processed.append('show')
            outfile.write(' show=%s' % (self.gds_format_string(quote_attrib(self.show), input_name='show'), ))
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.append('type_')
            # jeffdonner added xlink:
            outfile.write(' xlink:type=%s' % (self.gds_format_string(quote_attrib(self.type_), input_name='type'), ))
...
class Service(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Service', fromsubclass_=False, pretty_print=True):
        ...
        if self.Abstract is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAbstract>%s</%sAbstract>%s' % (namespace_, self.gds_format_string(quote_xml(self.Abstract), input_name='Abstract'), namespace_, eol_))
        ...
        if self.Fees is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sFees>%s</%sFees>%s' % (namespace_, self.gds_format_string(quote_xml(self.Fees), input_name='Fees'), namespace_, eol_))
        if self.AccessConstraints is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAccessConstraints>%s</%sAccessConstraints>%s' % (namespace_, self.gds_format_string(quote_xml(self.AccessConstraints), input_name='AccessConstraints'), namespace_, eol_))
...
class ContactInformation(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ContactInformation', fromsubclass_=False, pretty_print=True):
        ...
        if self.ContactPosition is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sContactPosition>%s</%sContactPosition>%s' % (namespace_, self.gds_format_string(quote_xml(self.ContactPosition), input_name='ContactPosition'), namespace_, eol_))
        ...
        if self.ContactVoiceTelephone is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sContactVoiceTelephone>%s</%sContactVoiceTelephone>%s' % (namespace_, self.gds_format_string(quote_xml(self.ContactVoiceTelephone), input_name='ContactVoiceTelephone'), namespace_, eol_))
        if self.ContactFacsimileTelephone is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sContactFacsimileTelephone>%s</%sContactFacsimileTelephone>%s' % (namespace_, self.gds_format_string(quote_xml(self.ContactFacsimileTelephone), input_name='ContactFacsimileTelephone'), namespace_, eol_))
        if self.ContactElectronicMailAddress is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sContactElectronicMailAddress>%s</%sContactElectronicMailAddress>%s' % (namespace_, self.gds_format_string(quote_xml(self.ContactElectronicMailAddress), input_name='ContactElectronicMailAddress'), namespace_, eol_))
    def hasContent_(self):
        if (
...
class ContactPersonPrimary(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ContactPersonPrimary', fromsubclass_=False, pretty_print=True):
        ...
        if self.ContactPerson is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sContactPerson>%s</%sContactPerson>%s' % (namespace_, self.gds_format_string(quote_xml(self.ContactPerson), input_name='ContactPerson'), namespace_, eol_))
        if self.ContactOrganization is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sContactOrganization>%s</%sContactOrganization>%s' % (namespace_, self.gds_format_string(quote_xml(self.ContactOrganization), input_name='ContactOrganization'), namespace_, eol_))
    def hasContent_(self):
        if (
...
class ContactAddress(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='ContactAddress', fromsubclass_=False, pretty_print=True):
        ...
        if self.AddressType is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sAddressType>%s</%sAddressType>%s' % (namespace_, self.gds_format_string(quote_xml(self.AddressType), input_name='AddressType'), namespace_, eol_))
        ...
        if self.City is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCity>%s</%sCity>%s' % (namespace_, self.gds_format_string(quote_xml(self.City), input_name='City'), namespace_, eol_))
        if self.StateOrProvince is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sStateOrProvince>%s</%sStateOrProvince>%s' % (namespace_, self.gds_format_string(quote_xml(self.StateOrProvince), input_name='StateOrProvince'), namespace_, eol_))
        if self.PostCode is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sPostCode>%s</%sPostCode>%s' % (namespace_, self.gds_format_string(quote_xml(self.PostCode), input_name='PostCode'), namespace_, eol_))
        if self.Country is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCountry>%s</%sCountry>%s' % (namespace_, self.gds_format_string(quote_xml(self.Country), input_name='Country'), namespace_, eol_))
    def hasContent_(self):
        if (
...
class Layer(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='Layer', fromsubclass_=False, pretty_print=True):
        ...
        for CRS_ in self.CRS:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sCRS>%s</%sCRS>%s' % (namespace_, self.gds_format_string(quote_xml(CRS_), input_name='CRS'), namespace_, eol_))
...
class BoundingBox(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='BoundingBox'):
        if self.CRS is not None and 'CRS' not in already_processed:
            ...
            outfile.write(' CRS=%s' % (self.gds_format_string(quote_attrib(self.CRS), input_name='CRS'), ))
...
class arcType(GeneratedsSuper):
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='', name_='arcType'):
        if self.fromxx is not None and 'fromxx' not in already_processed:
            ...
            outfile.write(' from=%s' % (self.gds_format_string(quote_attrib(self.fromxx), input_name='from'), ))
        if self.title_attr is not None and 'title_attr' not in already_processed:
            already_processed.append('title_attr')
            outfile.write(' title_attr=%s' % (quote_attrib(self.title_attr), ))
        if self.arcrole is not None and 'arcrole' not in already_processed:
        ...
        if self.to is not None and 'to' not in already_processed:
            ...
            outfile.write(' to=%s' % (self.gds_format_string(quote_attrib(self.to), input_name='to'), ))
        if self.show is not None and 'show' not in already_processed:
            already_processed.append('show')
            outfile.write(' show=%s' % (self.gds_format_string(quote_attrib(self.show), input_name='show'), ))
        if self.type_ is not None and 'type_' not in already_processed:
