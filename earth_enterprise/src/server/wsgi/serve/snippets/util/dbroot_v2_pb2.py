...
_NESTEDFEATUREPROTO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=str("icons/773_l.png", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
...
_CLIENTOPTIONSPROTO_PRECIPITATIONSOPTIONS = descriptor.Descriptor(
  ...
  nested_types=[_CLIENTOPTIONSPROTO_PRECIPITATIONSOPTIONS_WEATHERMAPPING, ],c
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_CLIENTOPTIONSPROTO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      number=15, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=str("http://*.google.com/*", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
...
_FETCHINGOPTIONSPROTO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=str("google.com gstatic.com", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
...
_AUTOPIAOPTIONSPROTO = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=str("http://cbk0.google.com/cbk", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
...
_ENDSNIPPETPROTO_SEARCHINFOPROTO = descriptor.Descriptor(
  ...
  fields=[
    descriptor.FieldDescriptor(
      ...
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=str("http://maps.google.com/maps", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      ...
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=str("q", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
  ],
...
_ENDSNIPPETPROTO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=True, default_value=str("hl=$[hl]", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
    ...
    descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=str("http://maps.google.com/maps/api/elevation/", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
...
_DBROOTPROTO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      has_default_value=True, default_value=str("en", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
