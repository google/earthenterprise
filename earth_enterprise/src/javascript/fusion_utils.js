...
function geeInitLeftPanelDivs() {
  ...
  var collapsePanelDiv = createElement(findElement(geeDivIds.header), 'div',
...
function resizeMap(divIds) {
  ...
  if (mapDiv) {
    ...
    // This was headerHeight but works better as 0px for maps.
