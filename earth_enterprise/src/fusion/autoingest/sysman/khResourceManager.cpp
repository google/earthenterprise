...
khResourceManager::GetCurrTasks(TaskLists &ret)
{
  ...
  // Get total size of objects in asset and asset version caches.
  ret.asset_cache_size = Asset::CacheObjectSize();
  ret.version_cache_size = AssetVersion::CacheObjectSize();
