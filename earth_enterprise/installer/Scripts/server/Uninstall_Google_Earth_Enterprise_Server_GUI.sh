...
if [ "$DISPLAY" == "" ]; then
        ...
        echo "    sudo ./Uninstall_Google_Earth_Enterprise_Server.sh"
exit
fi
...
/opt/google/install/GoogleEarthServer_Uninstaller/Uninstall_Google_Earth_Enterprise_Server_FUSION_VERSION_NUMBER -i GUI
