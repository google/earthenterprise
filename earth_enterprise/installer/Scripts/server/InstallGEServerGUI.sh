...
# X11 test: only needed for GUI installer
error_title="Error: X11 is not running and is required for this installer."
error_message="    You need to check that X11 is installed properly to install
    $product_name
    Note: $product_name does not require X11 so you may install in console mode using
