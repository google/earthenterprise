...
**Remove TCP/IP connections to PostgreSQL**. Open GEE code does, by default, connect to PostgreSQL exclusively using Unix domain sockets. This make it easier to secure PostgreSQL for security sensitive installations.
