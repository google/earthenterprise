...
.. container::
   ...
   .. container:: content
      ...
      retains current behavior. The value for ``PrunePercent`` can be any
      number from 0 up to 100. If the number of unwritten modified assets
      exceeds the configured percentage of the cache size, the cache will
      not attempt to prune.
