...
.. container::
   ...
   .. container:: content
      ...
      **Optimized command and message processing**.
      System manager's performance while handling cancel commands and updates
      about running tasks has been improved. These updates are experimental and
      can be enabled using the :ref:`GraphOperations flag <graph-operations>`.
