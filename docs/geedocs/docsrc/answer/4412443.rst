...
.. container::
   ...
   .. container:: content
      ...
      .. rubric:: Defining and Building Resources
         :name: defining-and-building-resources
      ...
      -  `Define Imagery Resources <#DefineImgRes>`__

         -  `Explore Imagery Source Files <#ExpImgRes>`__
         -  `Define Imagery Resources <#DefImgRes>`__
         -  `Build an Imagery Resource <#BuildImgRes>`__
         -  `Define and Build the Remaining Imagery
            Resources <#DefBuildRemImgRes>`__
         -  `Preview the Imagery Resources <#PreImgRes>`__

      -  `Define Terrain Resources <#DefTerrRes>`__

         -  `Explore Terrain Source Files <#ExpTerrSrc>`__
         -  `Define Terrain Resources <#DefTerrRes1>`__
         -  `Build and Modify Terrain Resources <#BuildModTerrRes>`__

      -  `Define Vector Resources <#44758>`__

         -  `Explore Vector Source Files <#ExpVecSrc>`__
         -  `Define a Vector Resource <#16927>`__
         -  `Build a Vector Resource <#BuildVecRes>`__
         -  `Define and Build the Remaining Vector
            Resources <#DefBuildRemVecRes>`__

      --------------

      .. rubric:: Define Imagery Resources
         :name: define-imagery-resources
      ...
      .. rubric:: Explore Imagery Source Files
         :name: explore-imagery-source-files
      ...
      .. rubric:: Define Imagery Resources
         :name: define-imagery-resources-1
      ...
      .. rubric:: Build an Imagery Resource
         :name: build-an-imagery-resource
      ...
      .. rubric:: Define and Build the Remaining Imagery Resources
         :name: define-and-build-the-remaining-imagery-resources
      ...
      .. rubric:: Preview the Imagery Resources
         :name: preview-the-imagery-resources
      ...
      .. rubric:: Explore Terrain Source Files
         :name: explore-terrain-source-files
      ...
      .. rubric:: Build and Modify Terrain Resources
         :name: build-and-modify-terrain-resources
      ...
      .. rubric:: Explore Vector Source Files
         :name: explore-vector-source-files
